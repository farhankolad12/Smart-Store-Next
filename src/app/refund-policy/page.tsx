  ...
  return (
    <>
      ...
      <main className="container my-5">
        ...
        <p>Thank you for shopping at Smart Store.</p>
        <p>
        ...
        <ul>
          <li>
            <p>
              ...
              in this Agreement) refers to Smart Store.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Smart Store, accessible from{" "}
              <Link href="https://smart-store.co.in">
                https://smart-store.co.in
              </Link>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <Link href="https://smart-store.co.in/contact">
              https://smart-store.co.in/contact
            </Link>
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>The Goods should not be used or damaged</li>
          <li>The Goods must have the receipt or proof of purchase</li>
        </ul>
        ...
        <p>Masjid, JAIL ZAPA, near Jail Road, Mangrol, Gujarat 362225, India</p>
        <p>
